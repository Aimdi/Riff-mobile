...
Map<String, Map<String, String>> get keys => {
  ...
  "stats": "Stats",
    ...
    "seeker": "Soulseek",
    "seekerPluginDes": "Search the Soulseek network for songs via your slskd server, and optionally open the Seeker Android app.",
    "soulseek": "Soulseek",
    "soulseekPluginDes": "Search the Soulseek network for songs via your slskd server. Queue downloads to slskd, or open Seeker on Android.",
    "soulseekDes": "Search songs on the Soulseek network through a self-hosted slskd server.",
    "soulseekSearchHint": "Search songs on Soulseek",
    "soulseekSearchNote": "Results come from peers on Soulseek. Downloads are queued on your slskd server — Riff does not transfer files itself.",
    "soulseekSearchPrompt": "Search for a song, artist, or album on Soulseek.",
    "soulseekSearching": "Searching Soulseek…",
    "soulseekNoResults": "No audio files found",
    "slskdConnectTitle": "Connect slskd",
    "slskdConnectDes": "Enter your slskd base URL and an API key from the slskd config. Credentials stay on this device.",
    "slskdServerUrl": "slskd URL",
    "slskdApiKey": "API key",
    "slskdConnect": "Connect",
    "slskdConnected": "Connected to slskd",
    "slskdConnectFailed": "Could not reach slskd — check the URL and API key",
    "slskdAuthFailed": "slskd rejected the API key",
    "slskdHint": "Install slskd (Docker or binary), add an API key under web.authentication.api_keys, sign in to Soulseek in the slskd UI, then connect here.",
    "slskdDocs": "slskd on GitHub",
    "slskdLoggedIn": "Soulseek online",
    "slskdLoggedInAs": "Soulseek as @user",
    "slskdNotLoggedIn": "slskd is reachable but not logged into Soulseek — sign in via the slskd web UI",
    "slskdNotConfigured": "Connect to slskd first",
    "slskdBusy": "Another search is already running on slskd — try again",
    "slskdSearchFailed": "Soulseek search failed — check slskd and try again",
    "slskdQueueDownload": "Queue download",
    "slskdDownloadQueued": "Download queued on slskd",
    "slskdDownloadFailed": "Could not queue the download on slskd",
    ...
    "seekerOpenApp": "Open Seeker app",
    "seekerGetPlay": "Get on Google Play",
    "seekerGetIzzy": "Get on IzzyOnDroid",
    "seekerOpenFailed": "Could not open Seeker",
    "seekerCompanionTitle": "Prefer a full mobile client?",
    "seekerCompanionDes": "Seeker is a standalone Soulseek app for Android. Riff searches through slskd so results stay in this app.",
    "seekerSoulSyncNote": "Tip: for automated Soulseek downloads on a home server, use SoulSync with slskd, or connect slskd directly here.",
    "speed": "Speed",
    "pitch": "Pitch",
    "done": "Done",
