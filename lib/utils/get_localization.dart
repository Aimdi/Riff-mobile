...
Map<String, Map<String, String>> get keys => {
  ...
  "absUploadForbidden":
      "Your account doesn't have upload permission on this server.",
  ...
  "skipPodcastAdsDes": "Automatically skip sponsor/ad chapters in podcasts that provide chapter markers.",
  "podcastContinuousPlayback": "Continuous podcast playback",
  "podcastContinuousPlaybackDes": "When an episode ends, play the next one from the queue or show list (AntennaPod-style autoplay).",
  "podcastAutoplayOn": "Autoplay on — next episode plays automatically",
  "podcastAutoplayOff": "Autoplay off — stop at end of episode",
  "podcastAutoplay": "Autoplay",
  "refreshInbox": "Refresh inbox",
  "auto": "Auto",
  "stop": "Stop",
  "removeDownload": "Remove download",
  "downloadStarted": "Downloading episode…",
  "downloadComplete": "Episode downloaded",
  "downloadFailed": "Download failed",
  "downloadRemoved": "Download removed",
  "identifySong": "Identify song",
  "listening": "Listening…",
  "couldNotIdentify": "Couldn't identify the song. Try again.",
  "micPermissionNeeded": "Microphone permission is needed to identify songs.",
  "recognitionFailed": "Recognition failed. Check your connection and token.",
  "identified": "Identified",
  "auddToken": "audD API token",
  ...
  "stats": "Stats",
    ...
    "searchPodcastsOrYoutube": "Search podcasts or paste a YouTube channel URL",
    "youtubeChannels": "YouTube channels",
    "youtubeChannelsDes": "Subscribe to watch uploads as podcast episodes — with optional video.",
    "subscribeYoutubeChannel": "Subscribe as podcast",
    "subscribedAsPodcast": "Subscribed as podcast",
    "alreadySubscribedPodcast": "Already in Podcasts",
    ...
    "torrentsDiggerPluginDes": "qBittorrent-style search across Torrents.csv, MAM, Redacted, Orpheus, 1337x (Music), RuTracker, AudioBook Bay. Open magnets or send to qBittorrent.",
    "torrentSearchPluginDes": "qBittorrent-style search across Torrents.csv, MAM, Redacted, Orpheus, 1337x (Music), RuTracker, AudioBook Bay. Open magnets or send to qBittorrent.",
    "torrents": "Torrents",
    "searchTorrents": "Search torrents",
    "torrentSearch": "Torrent Search",
    "torrentSearchDes": "Pick sources, search, then open or send to qBittorrent. Riff does not host or download files.",
    "torrentSearchHint": "Search torrents",
    "torrentSearchDisclaimer": "Only download content you have the right to use. Private sources need your own API key or cookie. 1337x and RuTracker are limited to music/audiobook categories.",
    ...
    "torrentSourceMamAdd": "MyAnonamouse…",
    "torrentSourceRedacted": "Redacted",
    "torrentSourceRedactedAdd": "Redacted…",
    "torrentSourceOrpheus": "Orpheus",
    "torrentSourceOrpheusAdd": "Orpheus…",
    "torrentSource1337x": "1337x (Music)",
    "torrentSourceRuTracker": "RuTracker (Music)",
    "torrentSourceAbb": "AudioBook Bay",
    "torrentConfigureSources": "Configure private sources",
    "torrentApiKey": "API key",
    "torrentSkipCookie": "Skip",
    "redactedConfigure": "Redacted",
    "redactedConfigureDes": "Paste an API key from Redacted → Settings → Access Settings. Enable Confirm API Key, then Save Profile.",
    "redactedConnected": "Redacted connected",
    "redactedConnectFailed": "Could not verify Redacted API key",
    "orpheusConfigure": "Orpheus",
    "orpheusConfigureDes": "Paste an API token from Orpheus → Settings → Access Settings → Create a new token.",
    "orpheusConnected": "Orpheus connected",
    "orpheusConnectFailed": "Could not verify Orpheus API token",
    "rutrackerConfigure": "RuTracker",
    "rutrackerConfigureDes": "Optional: paste your RuTracker session Cookie header after logging in (improves results and enables .torrent download). Music and audiobook forums only.",
    "rutrackerCookie": "Session cookie",
    "rutrackerConnected": "RuTracker cookie saved",
    "rutrackerConnectFailed": "Could not verify RuTracker cookie",
    ...
    "torrentOpenFailed": "Could not open link — install a torrent client",
    ...
    "mamConfigureDes": "Paste a dedicated mam_id session cookie from MyAnonamouse → Preferences → Security. Do not reuse a cookie shared with other apps.",
    "mamId": "mam_id cookie",
    "mamConnected": "MyAnonamouse connected",
    "mamConnectFailed": "Could not verify mam_id — check the cookie and try again",
    "qbitConfigure": "qBittorrent WebUI",
    "qbitConfigureDes": "Send magnets and download URLs to your qBittorrent instance. Enable WebUI and allow remote access.",
    "qbitUrl": "WebUI URL",
    "qbitAdded": "Added to qBittorrent",
    "qbitAddFailed": "Could not add to qBittorrent — check WebUI settings",
    "qbitSaved": "qBittorrent connected",
    "qbitSaveFailed": "Could not reach qBittorrent — check URL and password",
    "loadMore": "Load more",
    "soulSync": "SoulSync",
    ...
    "seeker": "Soulseek",
    "seekerPluginDes": "Built-in Soulseek client — log in, search like Sockseek (song/album, ranked results), and download to this device.",
    "soulseek": "Soulseek",
    "soulseekPluginDes": "Built-in Soulseek client — Sockseek-style song/album search with ranked results, then download to this device (no home server).",
    "soulseekDes": "Search and download music on the Soulseek network, right inside Riff.",
    ...
    "soulseekLoginFailed": "Could not sign in — check your username and password",
    "soulseekAccountHint": "Need an account? Create one on the Soulseek website (free).",
    "soulseekCreateAccount": "Create Soulseek account",
    ...
    "soulseekSearchingLive": "Searching… @count results so far",
    "soulseekNoResults": "No audio files found — try different keywords",
    "soulseekSearchFailed": "Search failed — check your connection and try again",
    "soulseekDownload": "Download",
    "soulseekDownloadAlbum": "Download folder",
    "soulseekAlbumDownloadDone": "Downloaded @count files from @name",
    "soulseekDownloadSaved": "Saved to @path",
    "soulseekDownloadFailed": "Download failed — try another peer with a free slot",
    "soulseekNotLoggedIn": "Sign in to Soulseek first",
    "soulseekInstalling": "Installing Soulseek client…",
    "soulseekInstalled": "Soulseek client ready",
    "soulseekModeSong": "Song",
    "soulseekModeAlbum": "Album",
  ...
  "riffWave": "Riff Wave",
  "riffWaveDes": "Your personal radio",
  "riffWaveEmpty": "Play a few songs first, then Wave can take over.",
  "waveMood": "Mood",
  "offlineHomeBanner": "Showing cached Home — tap to retry.",
